                        ...
                        <div class="hero">
                            <div class="pull-left login-desc-box-l">
                                ...
                                <div class="login-app-icons">
                                    <a href="https://thpt-locninh-binhphuoc.edu.vn/" class="csw-btn-button"
                                        rel="nofollow" target="_blank">Trang chủ THPT Lộc Ninh</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="formAuthentication" class="mb-3" action="" method="POST">
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Mã học sinh</label>
                                        <input type="text" class="form-control" id="txttdn" name="txttdn"
                                            placeholder="Nhập mã học sinh" autofocus />
                                    </div>
                                    <div class="mb-3 form-password-toggle">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" id="txtpass" class="form-control" name="txtpass"
                                                placeholder="Nhập mật khẩu" aria-describedby="password" />
