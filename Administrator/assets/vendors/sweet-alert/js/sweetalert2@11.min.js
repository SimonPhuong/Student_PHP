!function(e, t) {
    ...
    const a = {
      ...
      , A = (e,t)=>{
        ...
        for (let e = 0; e < n.length; e++) {
            var o = n[e];
            if (o instanceof HTMLElement && s(o, t))
                return o
        }
    }
      , c = (e,t,n)=>{
    ...
    const Ie = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
      ...
      , L = {}
      , Ue = (L.text = L.email = L.password = L.number = L.tel = L.url = (e,t)=>(Fe(e, t.inputValue),
    Ne(e, e, t),
    Ve(e, t),
    e.type = t.input,
    e),
    ...
    (e,t)=>{
        ...
        v(n, t, "htmlContainer"),
        t.html ? (Le(t.html, n),
        k(n, "block")) : t.text ? (n.textContent = t.text,
        k(n, "block")) : B(n),
        De(e, t)
    }
    )
      ...
      , $e = (e,t)=>{
        let n = e.innerHTML, o;
        var i;
        t.iconHtml ? o = Ge(t.iconHtml) : "success" === t.icon ? (o = Ze,
        n = n.replace(/ style=".*?"/g, "")) : o = "error" === t.icon ? Xe : (i = {
            question: "?",
            warning: "!",
            info: "i"
        },
      ...
      , nt = (e,t)=>{
        ...
        o.style.width = "100%",
        o.insertBefore(d(), $())) : c(o, "width", t.width),
        c(o, "padding", t.padding),
        t.color && (o.style.color = t.color),
        t.background && (o.style.background = t.background),
        B(te());
        n = o;
        (n.className = "".concat(p.popup, " ").concat(P(n) ? t.showClass.popup : ""),
      ...
      , dt = e=>{
        const n = {}
          ...
          , o = (t && (O(t, ["type", "label", "placeholder", "value"]),
        ...
        return o.length && (n.inputOptions = {},
        o.forEach(e=>{
            O(e, ["value"]);
    ...
    const bt = ()=>{
        ...
        document.body.style.paddingRight = "".concat(a.previousBodyPadding + (()=>{
      ...
      , yt = ()=>{
        null !== a.previousBodyPadding && (document.body.style.paddingRight = "".concat(a.previousBodyPadding, "px"),
      ...
      , kt = e=>{
        ...
        if (e.target === t) {
            const n = m();
            t.removeEventListener(Oe, kt),
            n.style.overflowY = "auto"
        }
    }
      , Bt = (e,t)=>{
        Oe && ye(t) ? (e.style.overflowY = "hidden",
        t.addEventListener(Oe, kt)) : e.style.overflowY = "auto"
    }
      , Pt = (e,t,n)=>{
        vt(),
        t && "hidden" !== n && bt(),
      ...
      , Et = (t,n)=>{
        ...
        F(n.inputOptions) || U(n.inputOptions) ? (M(h()),
      ...
      , St = n=>{
        ...
        return "undefined" != typeof Map && n instanceof Map ? n.forEach((e,t)=>{
            let n = e;
            "object" == typeof n && (n = St(n)),
            o.push([t, n])
        }
        ) : Object.keys(n).forEach(e=>{
            let t = n[e];
            "object" == typeof t && (t = St(t)),
            o.push([e, t])
        }
        ),
        o
    ...
    function Mt() {
        ...
        if (t) {
            ...
            B(n.loader),
            ce() ? t.icon && k($()) : (t = n,
            (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? k(e[0], "inline-block") : fe() && B(t.actions)),
      ...
      , Nt = (e,n,t)=>{
        ...
        if (o && (!n.isComposing && 229 !== n.keyCode))
            ...
            "Enter" === n.key)
                ...
                s = n,
                i = o,
                R(i.allowEnterKey) && s.target && e.getInput() && s.target instanceof HTMLElement && s.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(i.input) || (Ht(),
                s.preventDefault()));
            else if ("Tab" === n.key) {
                e = n;
                var i = o;
                ...
                if (!(document.activeElement instanceof HTMLElement) || [l, u, d].includes(document.activeElement)) {
                    ...
                    for (let e = 0; e < ne().children.length; e++) {
                        if (!(t = t[c]))
                            return;
                        if (t instanceof HTMLButtonElement && P(t))
                            break
                    }
    ...
    const Yt = e=>{
        e.isAwaitingPromise() ? (Zt(T, e),
        T.awaitingPromise.set(e, !0)) : (Zt(jt, e),
        Zt(T, e))
    }
      , Zt = (e,t)=>{
        for (const n in e)
    ...
    e = Object.freeze({
        ...
        _destroy: function() {
            ...
            delete x.currentInstance) : Yt(this)
        }
    });
    const Xt = (e,t)=>{
        ...
        if (n.input) {
            ...
            if (n.inputValidator) {
                ...
                e.getInput().checkValidity() ? ("deny" === t ? $t : Qt)(e, o) : (e.enableButtons(),
                e.showValidationMessage(n.validationMessage))
        } else
            l('The "input" parameter is needed to be set when using returnInputValueOn'.concat(q(t)))
    }
      , $t = (t,n)=>{
        const e = T.innerParams.get(t || void 0);
        if (e.showLoaderOnDeny && M(f()),
        e.preDeny) {
      ...
      , Qt = (t,n)=>{
        const e = T.innerParams.get(t || void 0);
        if (e.showLoaderOnConfirm && M(),
        e.preConfirm) {
            t.resetValidationMessage(),
            T.awaitingPromise.set(t || void 0, !0);
            const o = Promise.resolve().then(()=>u(e.preConfirm(n, e.validationMessage)));
            o.then(e=>{
                P(te()) || !1 === e ? (t.hideLoading(),
                Ut(t)) : Jt(t, void 0 === e ? n : e)
            }
            ).catch(e=>Gt(t || void 0, e))
        } else
            Jt(t, n)
    ...
    var mn = Object.freeze({
        ...
        bindClickHandler: function() {
            ...
            dn[e] = this,
            un || (document.body.addEventListener("click", pn),
            un = !0)
        }
    });
    let j;
    ...
    const gn = (l,u,d)=>new Promise((e,t)=>{
        ...
        t = u,
        r = n,
        T.innerParams.get(e).toast ? en(e, t, r) : (nn(t),
        on(t),
        rn(e, t, r)),
        o = l,
        e = x,
        ...
        i = n,
        It(e),
        t.toast || (e.keydownHandler = e=>Nt(o, e, i),
        ...
        r = l,
        "select" === (t = d).input || "radio" === t.input ? Et(r, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (F(t.inputValue) || U(t.inputValue)) && (M(h()),
        Tt(r, t));
        {
            var a = d;
            const s = m()
      ...
      , bn = (e,t,n)=>{
        var o = ie();
        B(o),
        t.timer && (e.timeout = new ft(()=>{
            n("timer"),
            delete e.timeout
        }
        ,t.timer),
        t.timerProgressBar && (k(o),
      ...
      , vn = (e,t)=>t.focusDeny && P(e.denyButton) ? (e.denyButton.focus(),
    !0) : t.focusCancel && P(e.cancelButton) ? (e.cancelButton.focus(),
    !0) : !(!t.focusConfirm || !P(e.confirmButton)) && (e.confirmButton.focus(),
    !0)
      , wn = ()=>{
