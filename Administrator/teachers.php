                ...
                <div class="align-self-center">
                    <div class="d-flex flex-wrap gap-2 flex-lg-row justify-content-center align-content-center">
                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            ...
                            <div class="align-self-center">
                                <a href="create.teacher.php" role="button" class="btn-add" data-bs-toggle="tooltip"
                ...
                <table class="table table-bordered" id="table">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="sorting_desc">Degree</th>
                            <th class="sorting_desc">Subject</th>
                            <th colspan="2">
                    ...
                    <tbody class="tbody">
                        <?php 
                            ...
                            $query = $con->prepare("SELECT t.id, t.first_name, t.last_name, t.gender, t.phone, t.email, t.degree, s.subject_name, u.id_user 
                                                    ...
                                                    WHERE (t.first_name LIKE CONCAT('%', :searchKeyword, '%'))
                                                    OR (t.last_name LIKE CONCAT('%', :searchKeyword, '%'))
