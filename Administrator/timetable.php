            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Thêm thời khoá biểu</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body" >
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" class="btn btn-primary"  onClick="showTimeTable(this)">Tiếp tục</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {	
				...
				//MSK-000126-form submit
					...
					if(day == 'Chọn ngày' || subject == 'Chọn môn học' || teacher == 'Chọn giáo viên' || classroom == 'Chọn lớp' || start_time == '' || end_time == '' ){
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				<div class="modal-header bg-primary">
        			...
        			<h4 class="modal-title" id="frm_title">Xoá tiết</h4>
      			</div>

				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">Bạn chắc chắn chưa?</strong>  Bạn muốn xoá tiết học này?
        		</div>
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes" class="deletebtn btn btn-danger col-sm-2 pull-right">Xác nhận</a><!-- MSK-000154 -->
        			<button type="button" class="btn btn-primary col-sm-2 pull-right" data-dismiss="modal" id="frm_cancel">Huỷ</button>
      			</div>
    		</div>
  		</div>
	</div>
