...
header('location:index.php');
    ...
    $query=mysqli_query($con,"insert into news(tieude,noidung) values('$tieude','$noidung')");
    if($query)
    {
    $msg="Lưu và đăng bài viết thành công";
    }
    else{
    $error="Lỗi!";    
    } 
                                ...
                                <div class="">
                                    <form name="addpost" method="post" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="submit"
                                            class="btn btn-success waves-effect waves-light">Lưu và đăng</button>
                                        <button type="button" class="btn btn-danger waves-effect waves-light">Huỷ
                                            bỏ</button>
                                    </form>
                                </div>
                            </div> <!-- end p-20 -->
