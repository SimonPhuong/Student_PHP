...
if (isset($_POST['update_student_btn'])) 
{
    ...
    $query = "UPDATE students SET first_name = ?, last_name = ?, grade_id = ?, classroom_id = ? WHERE id = ?";
    $stmt = $con->prepare($query);
    $stmt->execute([$first_name, $last_name, $grade_id, $classroom_id, $_GET['id']]);
    ...
    <div class="card-body">
        ...
        if(isset($_GET['id']))
        {
            ...
            $stmt = $con->prepare("SELECT * FROM students
                                    ...
                                    WHERE students.id = :student_id LIMIT 1");
        ...
        <form method="POST" action="" onsubmit="return validateForm()">
            ...
            <div class="row mb-5">
                ...
                <div class="col-12 col-sm-3">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control ot-form-control ot-input mt-2" name="grade" id="grade">
                            <option value="">Select Grade</option>
                            <?php foreach ($grades as $grade) :  ?>
                            <option value="<?= $grade['id']; ?>"
                                <?php if ($student['grade_id'] == $grade['id']) echo 'selected'; ?>>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control ot-form-control ot-input mt-2" name="classroom" id="classroom">
                            ...
                            <option value="<?= $classroom['id']; ?>"
                                <?php if ($student['classroom_id'] == $classroom['id']) echo 'selected'; ?>>
                ...
                <div class="col-12 col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ot-form-control ot-input" name="id_user"
                            value="<?= $student['id_user'] ?>" readonly>
                    </div>
                </div>
            ...
            <hr>
            <button style="float: right;" type="submit" class="btn-submit" name="update_student_btn">Create</button>
        </form>
    </div>
</div>
<script>
